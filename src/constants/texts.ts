export const texts = {
    ...
    aboutSection: {
        header: 'Curious about the StockX Mystery Box?',
        firstParagraph:
    ...
    productSection: {
        header: 'Why is everyone buzzing about these boxes?',
        firstParagraph:
    ...
    faqSection: {
        firstQuestion: 'How can I win?',
        secondQuestion: 'No hidden fees?',
        thirdQuestion: 'Why do we need your billing information?',
        firstAnswer:
    ...
    footer: {
        cards: 'We accept the following credit cards',
    },
};
